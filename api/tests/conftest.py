...
def mock_aws_services():
    ...
    with mock_dynamodb(), mock_s3(), mock_sqs(), mock_cognito_idp():
        ...
        os.environ["IMAGE_QUEUE_URL"] = (
            "https://sqs.us-east-1.amazonaws.com/123456789/test-image-queue"
        )
...
def sample_pantry_item():
    ...
    return {
        ...
        "category": "fruit",
        "barcode": "123456789",
        "nutritional_info": {"calories": 52, "protein": 0.3, "carbs": 13.8, "fat": 0.2},
    }
...
def mock_openai_calls():
    ...
    with patch("openai.ChatCompletion.create") as mock_openai:
        mock_openai.return_value = {
            "choices": [
                {"message": {"content": '{"calories": 100, "protein": 2, "carbs": 25, "fat": 0}'}}
            ]
        }
        yield mock_openai
